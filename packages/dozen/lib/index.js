...
const TaskList = ({ className = '', ariaLabel, tasks, state = 'complete-tasks', }) => {
    ...
    useEffect(() => {
        var _a;
        const newPositionPerIndex = (_a = orderedTasks === null || orderedTasks === void 0 ? void 0 : orderedTasks.map((task) => { var _a, _b; return ((_b = (_a = refs[task.id]) === null || _a === void 0 ? void 0 : _a.clientHeight) !== null && _b !== void 0 ? _b : 20) / 2 - 10; })) !== null && _a !== void 0 ? _a : [];
...
const CompleteTasks = ({ className = '', ariaLabel, }) => {
    return (jsx("div", { className: `ds-makersun-dozen-complete-tasks-container ${className}`, "data-testid": `ds-makersun-dozen-complete-tasks`, "aria-label": ariaLabel, tabIndex: 0, children: jsx("img", { src: img, alt: "Complete task icon" }) }));
};

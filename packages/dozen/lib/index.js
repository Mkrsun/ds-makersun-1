...
const MoveHand = ({ className = '', ariaLabel, width = 24, height = 24, }) => {
    return (jsx("div", { className: `ds-makersun-dozen-move-hand-container ${className}`, "data-testid": `ds-makersun-dozen-move-hand`, "aria-label": ariaLabel, tabIndex: 0, children: jsx(img$1, { width: width, height: height, alt: "move hand icon" }) }));
};
...
const CompleteTasks = ({ className = '', ariaLabel, width = 24, height = 24, }) => {
    return (jsx("div", { className: `ds-makersun-dozen-complete-tasks-container ${className}`, "data-testid": `ds-makersun-dozen-complete-tasks`, "aria-label": ariaLabel, tabIndex: 0, children: jsx(img, { width: width, height: height, alt: "Complete task icon" }) }));
};
